  ...
  <el-tabs v-model="activeName" class="search-tab">
    <el-tab-pane label="水系" name="shuiXi">
      ...
      <div class="data-static">
        <div id="chart" style="height: 200px; width: 355px; background-color: rgba(255,255,255,0.3)"></div>
      </div>
    ...
    <el-tab-pane label="水利资源检索" name="safe">
    ...
    <el-tab-pane label="数据统计" name="statistic">
      <div id="number-statistic-3" style="height: 300px; width: 355px"></div>
      <label for="number-statistic-1">水利工程统计1</label>
      <div id="number-statistic-1" style="height: 300px; width: 355px"></div>
      <label for="number-statistic-2">水利工程统计2</label>
      <div id="number-statistic-2" style="height: 300px; width: 355px"></div>
    </el-tab-pane>
  </el-tabs>
</template>
<script>
...
export default {
  ...
  mounted() {
    ...
    const num1charts = echarts.init(document.getElementById("number-statistic-1"))
    const num2charts = echarts.init(document.getElementById("number-statistic-2"))
    const num3charts = echarts.init(document.getElementById("number-statistic-3"))
    num1charts.setOption({
      tooltip: {
        trigger: 'axis',
        axisPointer: {
          type: 'shadow'
      ...
      xAxis: [
        {
          type: 'category',
          data: ['灌区','拟建水库','转移路线','水网管线','涉河建筑物','采砂点位','太阳能提灌站'],
          axisTick: {
            alignWithLabel: true
          }
        }
      ...
      series: [
        {
          ...
          type: 'bar',
          barWidth: '60%',
          data: [274, 8, 20, 8, 95, 9, 5]
        }
      ]
    })
    num2charts.setOption({
      tooltip: {
        trigger: 'axis',
        axisPointer: {
          type: 'shadow'
      ...
      xAxis: [
        {
          type: 'category',
          data: ['护岸', '堤防', '水资源', '灾害点', '水电站', '水文站', '河流湖泊'],
          axisTick: {
            alignWithLabel: true
          }
        }
